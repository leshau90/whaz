...
\begin{center}
    \begin{longtable}{|p{4cm}|p{3cm}|p{4cm}|p{4cm}|}
        ...
        & \autocite{DesignScienceHevner2004}
        & Bagaimana mendesain sistem dan mempresentsaikan sistem tersebut  
        & Metode penelitian dalam mendesin sebuah sistem informasi
        \\
        \hline
        \usebibentry{ComparativeAnaWaluyo2022}{title}, International Journal of Computer and Information Technology(2279-0764)
        & \autocite{ComparativeAnaWaluyo2022}
